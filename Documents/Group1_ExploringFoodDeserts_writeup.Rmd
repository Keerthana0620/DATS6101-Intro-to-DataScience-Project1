...
footer {
  ...
  left: 0;
  width: 19%;
  background-color: azure; /* Background color for the footer */
...
body {
  background-color: beige; /* Change to your desired background color */
  background-image: url('image2.webp'); /* URL to your background image */
  background-repeat: no-repeat;
