...
#metrics_data_LILA <- rbind(metrics_data_LILA, c("CART", "accuracy", test_R2))
#metrics_data_LILA <- rbind(metrics_data_LILA, c("CART", "Precision", bestRMSE))
#metrics_data_LILA <- rbind(metrics_data_LILA, c("CART", "Recall", bestRMSE))
#metrics_data_LILA <- rbind(metrics_data_LILA, c("Logistic", "accuracy", test_R2))
#metrics_data_LILA <- rbind(metrics_data_LILA, c("Logistic", "Precision", bestRMSE))
#metrics_data_LILA <- rbind(metrics_data_LILA, c("Logistic", "Recall", bestRMSE))
